...
def add_category(category_code, name):
      try:
            sql = 'INSERT INTO category (category_code, name) VALUES (%s, %s);'    
            cursor = db.get_cursor()    
            cursor.execute(sql,(category_code, name))  
...
def delete_category(category_code):
      try:
         ...
         if 'FOREIGN KEY' in str(err):
            return {'success': False, 'message': 'This Category is in use. It can not be deleted!'}    
         else:
            return {'success': False, 'message': 'Somethings Wrong'}   
...
def delete_product_by_code(product_code):
      try:
        ...
        return {'success': True, 'message': 'Product Deleted Successfully'}
         ...
         if 'FOREIGN KEY' in str(err):
            return {'success': False, 'message': 'This Product is in use. It can not be deleted!'}    
         else:
            return {'success': False, 'message': 'Somethings Wrong'}   
